...
class TwoStageDetector_seg(BaseDetector, RPNTestMixin, BBoxTestMixin,
                       MaskTestMixin):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(TwoStageDetector_seg, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(TwoStageDetector_seg, self).init_weights(pretrained)
    ...
    def extract_feat(self, img, weight=None):
    ...
    for i in img_meta:
        ...
        with open(os.path.join(dir_root, set_name, file_name), 'r') as f:
            ...
            if len(weight):
                ...
                weight = F.pad(weight, pad=pad, mode='replicate')[0, :, :, :]
                weight_list.append(weight)
            else:
                weight_list.append(torch.ones(pad_shape[:-1])[ None, :, :])
